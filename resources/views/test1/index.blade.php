                        ...
                        @if ($i <= 5)
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="text-center">
                                    <div class="border m-2 py-3 border-2 border-secondary-emphasis rounded-3">
                                    <div class="row">
                                            <div class="col">
                    ...
                    @else
                        @foreach ($weather_rain as $i => $weather)
                            ...
                            <div class="col-md-2 rounded">
                                ...
                                <div class="text-center">
                                    <div class="border m-2 py-3 border-2 border-secondary-emphasis rounded-3" style="background-color:#{{ $weather['rainfall_color'] }} !important">
                                        {{ $weather['rainfall'] }} mm
                                    </div>
                                </div>
